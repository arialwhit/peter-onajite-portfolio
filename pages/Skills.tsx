...
const Skills: React.FC = () => {
  const categories = [
    ...
    { id: 'ai', title: 'AI & Advanced Integrations' },
    { id: 'realtime', title: 'Real-Time & Financials' },
    { id: 'payments', title: 'Payments & SaaS' },
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-32 glass-card p-12 rounded-[3rem] text-center border-white/5">
          <h3 className="text-3xl font-bold mb-8">Developer Tools</h3>
          <div className="flex flex-wrap justify-center gap-4 text-slate-400">
            {['Git', 'GitHub', 'Vercel', 'Postman', 'Docker'].map(tool => (
